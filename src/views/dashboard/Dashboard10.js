...
const Dashboard10 = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/dashboard10_data.php`)
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-Dashboard3-wrap">
          <CCol lg="12" className="text-center main-head">
            <h5>Product Audit Demerit - All Zones Performance - LMD</h5>
          </CCol>
          <CCol lg="12">
                ...
                <CRow>
                    ...
                    <CCard className="main-card-6">
                      <CCardBody className={"scroll-table-6"}>
                        <div className="col-md-12 gauge-gaurd-title text-center">
                          <h3 style={{fontSize:"2.5vh"}}>Weekly Demerit Trend-LMD Zone-1</h3>
                        </div>
                  ...
                  <CCol lg="6">
                    <CCard className="main-card-6">
                      <CCardBody className={"scroll-table-6"}>
                        <div className="col-md-12 gauge-gaurd-title text-center">
                          <h3 style={{fontSize:"2.5vh"}}>Weekly Demerit Trend-LMD Zone-2</h3>
                        </div>
                ...
                <CRow>
                  <CCol lg="6">
                    <CCard className="main-card-6">
                      <CCardBody className={"scroll-table-6"}>
                        <div className="col-md-12 gauge-gaurd-title text-center">
                          <h3 style={{fontSize:"2.5vh"}}>Weekly Demerit Trend-LMD Zone-3</h3>
                        </div>
                        <table className="table table-hover table-striped table-bordered table-sm blue-table">
                          <thead style={{ textAlign: "center" }}>
                            <tr>
                  ...
                  <CCol lg="6">
                    <CCard className="main-card-6">
                      <CCardBody className={"scroll-table-6"}>
                        <div className="col-md-12 gauge-gaurd-title text-center">
                          <h3 style={{fontSize:"2.5vh"}}>Weekly Demerit Trend-LMD Zone-4</h3>
                        </div>
                        <table className="table table-striped table-bordered table-sm blue-table">
                          <thead style={{ textAlign: "center" }}>
                            <tr>
                ...
                <CRow>
                  <CCol lg="6">
                    <CCard className="main-card-6">
                      <CCardBody className={"scroll-table-6"}>
                        <div className="col-md-12 gauge-gaurd-title text-center">
                          <h3 style={{fontSize:"2.5vh"}}>Weekly Demerit Trend-LMD Zone-5</h3>
                        </div>
                        <table className="table table-hover table-striped table-bordered table-sm blue-table">
                          <thead style={{ textAlign: "center" }}>
                            <tr>
                  ...
                  <CCol lg="6">
                    <CCard className="main-card-6">
                      <CCardBody className={"scroll-table-6"}>
                        <div className="col-md-12 gauge-gaurd-title text-center">
                          <h3 style={{fontSize:"2.5vh"}}>Weekly Demerit Trend-LMD Zone-6</h3>
                        </div>
                        <table className="table table-striped table-bordered table-sm blue-table">
                          <thead style={{ textAlign: "center" }}>
                            <tr>

...
const DashboardTable_LMD = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/dashboard_Table_LMD.php`)
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-Dashboard3-wrap">
          <CCol lg="12" className="text-center main-head">
            <h5>Product Audit Demerit - All Zones Performance Summary - LMD</h5>
          </CCol>
          <CCol lg="12">
...
export default DashboardTable_LMD;

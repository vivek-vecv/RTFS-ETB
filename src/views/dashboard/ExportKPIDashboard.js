...
const ExportKPIDashboard = () => {
    ...
    useEffect(() => {
        axios
            .get(`${API_URL}/dashboard_data.php`)
    ...
    return (
        <>
            {isLoading ? (
                ...
                <CRow className="main-dashboard-wrap" style={{ display: "flex", justifyContent: "center" }}>
                    <CCol lg="12" className="text-center main-head">
                        <h5>Product Audit Demerit - Controlled KPI Dashboard - Export</h5>
                    </CCol>

                    <CCol lg="4" style={{ display: "none" }}>
...
export default ExportKPIDashboard;

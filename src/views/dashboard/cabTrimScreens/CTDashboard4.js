...
const CTDashboard4 = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/dashboard4_data.php${props.location.search}`)
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-dashboard4-wrap">
          <CCol lg="12" className="text-center main-head">
            <h5>
              Product Audit Demerit Alert & Feedback - {zone} - {line}
            </h5>
          </CCol>
          <CCol lg="12">
            <CRow className="main-row main-row-1">
              <CCol md="12">
                <div
                  className="inner-box inner-box-dash2"
                  onClick={() => {
                    setOpen(true);
                  }}
                >

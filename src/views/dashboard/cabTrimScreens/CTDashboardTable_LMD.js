...
const CTDashboardTable_LMD = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/ctdashboardtable_lmd_data.php`)
  ...
  let CTDZonewiseData = [
    ZONEWISETRENDDemerit[0],
    ZONEWISETRENDDemerit[1],
    ZONEWISETRENDDemerit[2],
  ];

  let CTDCRITICALDEMERITCOUNTDemerit = [
    CRITICALDEMERITCOUNTDemerit[0],
    CRITICALDEMERITCOUNTDemerit[1],
    CRITICALDEMERITCOUNTDemerit[2],
  ];
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-Dashboard3-wrap">
          <CCol lg="12" className="text-center main-head">
            <h5>Product Audit Demerit - All Zones Performance Summary - LMD-CT</h5>
          </CCol>
          <CCol lg="12">
                    ...
                    <CCard className="main-card-6" style={{ marginTop: "5px" }}>
                      <CCardBody className={"scroll-table-6"}>
                        ...
                        <table className="table table-hover table-striped table-bordered table-sm blue-table">
                          ...
                          <tbody>
                            {CTDZonewiseData.map((item, index) => {
                              return (
                                <tr
                                  key={index.toString()}
                                  align="center"
                    ...
                    >
                      <CCardBody className={"scroll-table-6"}>
                        ...
                        <table className="table table-striped table-bordered table-sm blue-table">
                          ...
                          <tbody>
                            {CTDCRITICALDEMERITCOUNTDemerit.map(
                              (item, index) => {
                                return (
                                  <tr
                                    key={index.toString()}
...
export default CTDashboardTable_LMD;

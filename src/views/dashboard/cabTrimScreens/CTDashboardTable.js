...
const CTDashboardTable = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/ctdashboardtable_data.php`)
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-Dashboard3-wrap">
          <CCol lg="12" className="text-center main-head">
            <h5>Product Audit Demerit - All Zones Performance Summary - HD-CT</h5>
          </CCol>
          <CCol lg="12">
...
export default CTDashboardTable;

...
const CabweldDashboard4 = (props) => {
    ...
    useEffect(() => {
        axios
            .get(`${API_URL}/CabweldDashboard4.php${props.location.search}`)
            ...
            {isLoading ? (
                ...
                <CRow className="main-dashboard-wrap main-dashboard4-wrap">
                    <CCol lg="12" className="text-center main-head">
                        ...
                        <h5>Demerit Alert & Feedback Cabweld</h5>
                        <h5 style={{ marginRight: "10%" }}>Cabweld</h5>
                    </CCol>
                    <CCol
                        lg="12"
...
export default CabweldDashboard4;

...
import ExportKPIDashboard from "../ExportKPIDashboard";
import ExportDashboard4 from "../ExportDashboard4";
...
const ExportDashboard = (props) => {
    ...
    const [screen, setScreen] = useState("ExportKPIDashboard");
    const timeGap = 120;
    ...
    const dashboardTimer = [
        { screen: "ExportKPIDashboard", time: timeGap },

        { screen: "ExportDashboard4", time: timeGap },
    ...
    const renderComponent = () => {
        ...
        switch (screen) {
            case "ExportKPIDashboard":
                return <ExportKPIDashboard location={{ search: `?Category=${category}` }} />;
            case "ExportDashboard4":
                return (
                    <ExportDashboard4 location={{ search: `?Category=${category}` }} />
                );

...
const LMDCTDashboard = (props) => {
    const parsed = QueryString.parse(props.location.search);
    const [zone, setZone] = useState(parsed.Zone ? parsed.Zone : "Zone-3");
    const [line, setLine] = useState(parsed.Line ? parsed.Line : "LD-CT");

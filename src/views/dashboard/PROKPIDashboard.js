...
const PROKPIDashboard = (props) => {
    ...
    useEffect(() => {
        axios
            .get(`${API_URL}/PROKPIDashboard.php${props.location.search}`)
            .then(function (response) {
                if (response && response.data) {
                    ...
                    setDemeritsUD({ data: UDData, labels: labelsZone });
                    setLoading(false);
                }
            })
        ...
        axios
            .get(`${API_URL}/PROKPIDashboard_table.php${props.location.search}`)
            .then(function (response) {
                if (response && response.data) {

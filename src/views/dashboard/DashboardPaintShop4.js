...
const DashboardPaintShop4 = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/dashboard4_PaintShop_data.php${props.location.search}`)
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-dashboard4-wrap">
          <CCol lg="12" className="text-center main-head">
            ...
            <h5>Demerit Alert & Feedback Paint Shop</h5>
            <h5 style={{ marginRight: "10%" }}>Paint Shop</h5>
          </CCol>
          <CCol
            lg="12"
...
export default DashboardPaintShop4;

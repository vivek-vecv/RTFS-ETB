...
const FVIDashboard4 = (props) => {
    ...
    const [stn, setStn] = useState("LMD_FVI")
    ...
    useEffect(() => {
        axios
            .get(`${API_URL}/FVIDashboard4_data.php${props.location.search}`)

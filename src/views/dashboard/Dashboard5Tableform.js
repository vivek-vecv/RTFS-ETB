...
const Dashboard5Tableform = (props) => {
                                                ...
                                                <tbody>
                                                    ...
                                                    <>
                                                        <tr >
                                                            ...
                                                            <td className={"text-center"}>{DemeritpreviousmnthData[0]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritcurrentmnthData[0]}
                                                            </td>
                                                            <td className={"text-center"}>{DemeritHeadWeekData[0]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritdaybeforeyesterdayData[0]}
                                                            </td>
                                                            <td className={"text-center"}>
                                                                {DemeritpreviosdayData[0]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritcurrentdayData[0]}
                                                            </td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <>
                                                        <tr >
                                                            ...
                                                            <td className={"text-center"}>{DemeritpreviousmnthData[1]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritcurrentmnthData[1]}
                                                            </td>
                                                            <td className={"text-center"}>{DemeritHeadWeekData[1]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritdaybeforeyesterdayData[1]}
                                                            </td>
                                                            <td className={"text-center"}>
                                                                {DemeritpreviosdayData[1]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritcurrentdayData[1]}
                                                            </td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <>
                                                        <tr >
                                                            ...
                                                            <td className={"text-center"}>{DemeritpreviousmnthData[2]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritcurrentmnthData[2]}
                                                            </td>
                                                            <td className={"text-center"}>{DemeritHeadWeekData[2]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritdaybeforeyesterdayData[2]}
                                                            </td>
                                                            <td className={"text-center"}>
                                                                {DemeritpreviosdayData[2]}</td>
                                                            <td className={"text-center"} >
                                                                {DemeritcurrentdayData[2]}
                                                            </td>
...
export default Dashboard5Tableform;

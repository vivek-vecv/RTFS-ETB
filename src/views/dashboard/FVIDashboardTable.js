...
const FVIDashboardTable = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/FVIdashboardTable.php${props.location.search}`)
      ...
      {isLoading ? (
        ...
        <CRow className="main-dashboard-wrap main-Dashboard3-wrap">
          <CCol lg="12" className="text-center main-head">
            <h5>FVI - All Zones Performance Summary - {Line}</h5>
          </CCol>
          <CCol lg="12">
...
export default FVIDashboardTable;

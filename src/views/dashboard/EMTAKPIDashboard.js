...
const EMTAKPIDashboard = (props) => {
    ...
    useEffect(() => {
        axios
            .get(`${API_URL}/EMTAKPIDashboard.php${props.location.search}`)
                ...
                <CRow className="main-dashboard-wrap">
                    ...
                    <CCol lg="3">
                        <div className="inner-box">
                            <div className="row">
                                <div className="col-12 align-content-center">
                                    <h5 className="vehicleTitle">Demerit {category} - HD</h5>
                                </div>
                            </div>
                            {/* New code */}
                            <div className="row ">
                            ...
                            <div className="row">
                                <div className="col-md-12 gauge-gaurd-title text-center">
                                    <h3>Demerit Trend -  {category} - HD</h3>
                                </div>
                                {/* <div className="col-md-12 vehicle-trend-title text-center"><h3>Demerit per Vehicle Trend</h3></div> */}
                                <div className="col-12">
                                    <CCard className="main-card-12">
                    ...
                    <CCol lg="3">
                        <div className="inner-box">
                            <div className="row">
                                <div className="col-12 align-content-center">
                                    <h5 className="vehicleTitle">Demerit  {category} - LMD</h5>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-12 gauge-gaurd-title text-center">
                                    <h3>Demerit Trend -  {category} - LMD</h3>
                                </div>
                                {/* <div className="col-md-12 vehicle-trend-title text-center"><h3>Demerit per Vehicle Trend</h3></div> */}
                                <div className="col-12">
                                    <CCard className="main-card-12">
...
export default EMTAKPIDashboard;
